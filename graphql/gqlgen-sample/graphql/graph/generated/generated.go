...
scalar Time
`, BuiltIn: false},
	{Name: "graph/tag.graphql", Input: `type Tag {
    id: ID!
    name: String!
    createdAt: Time!
    updatedAt: Time!
...
func (ec *executionContext) _Mutation_createPost(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		if data, ok := tmp.(*gqlmodel.Post); ok {
			return data, nil
		}
		return nil, fmt.Errorf(`unexpected type %T from directive, should be *graphql/graph/gqlmodel.Post`, tmp)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Post_user(ctx context.Context, field graphql.CollectedField, obj *gqlmodel.Post) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
	...
	fc.Result = res
	return ec.marshalNUser2ᚖgraphqlᚋgraphᚋgqlmodelᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_users(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*gqlmodel.User)
	fc.Result = res
	return ec.marshalNUser2ᚕᚖgraphqlᚋgraphᚋgqlmodelᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Tag_createdAt(ctx context.Context, field graphql.CollectedField, obj *gqlmodel.Tag) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Tag_updatedAt(ctx context.Context, field graphql.CollectedField, obj *gqlmodel.Tag) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) marshalNTag2ᚕᚖgraphqlᚋgraphᚋgqlmodelᚐTagᚄ(ctx context.Context, sel ast.SelectionSet, v []*gqlmodel.Tag) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNTag2ᚖgraphqlᚋgraphᚋgqlmodelᚐTag(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNTag2ᚖgraphqlᚋgraphᚋgqlmodelᚐTag(ctx context.Context, sel ast.SelectionSet, v *gqlmodel.Tag) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalNUser2ᚕᚖgraphqlᚋgraphᚋgqlmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v []*gqlmodel.User) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalOUser2ᚖgraphqlᚋgraphᚋgqlmodelᚐUser(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNUser2ᚖgraphqlᚋgraphᚋgqlmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v *gqlmodel.User) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
