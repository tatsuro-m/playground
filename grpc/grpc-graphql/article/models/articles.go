...
var ArticleWhere = struct {
	...
	Author:    whereHelperstring{field: "`articles`.`author`"},
...
var (
	articleAllColumns            = []string{"id", "author", "title", "content", "created_at", "updated_at"}
	articleColumnsWithoutDefault = []string{"author", "title", "content"}
	articleColumnsWithDefault    = []string{"id", "created_at", "updated_at"}
