...
func (*Article) Descriptor() ([]byte, []int) {
	return fileDescriptor_article_032e5e91cdf93eb6, []int{0}
}
...
func (*ArticleInput) Descriptor() ([]byte, []int) {
	return fileDescriptor_article_032e5e91cdf93eb6, []int{1}
}
...
func (dst *ArticleInput) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ArticleInput.Merge(dst, src)
}
...
type CreateArticleRequest struct {
	ArticleInput         *ArticleInput `protobuf:"bytes,1,opt,name=articleInput" json:"articleInput,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
...
func (*CreateArticleRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_article_032e5e91cdf93eb6, []int{2}
}
...
func (*CreateArticleResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_article_032e5e91cdf93eb6, []int{3}
}
...
func (*ReadArticleRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_article_032e5e91cdf93eb6, []int{4}
}
...
func (dst *ReadArticleRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReadArticleRequest.Merge(dst, src)
}
...
func (*ReadArticleResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_article_032e5e91cdf93eb6, []int{5}
}
...
func (dst *ReadArticleResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReadArticleResponse.Merge(dst, src)
}
...
type UpdateArticleRequest struct {
	Id                   int64         `protobuf:"varint,1,opt,name=id" json:"id,omitempty"`
	ArticleInput         *ArticleInput `protobuf:"bytes,2,opt,name=articleInput" json:"articleInput,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
...
func (*UpdateArticleRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_article_032e5e91cdf93eb6, []int{6}
}
...
func (dst *UpdateArticleRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateArticleRequest.Merge(dst, src)
}
...
func (*UpdateArticleResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_article_032e5e91cdf93eb6, []int{7}
}
...
func (dst *UpdateArticleResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateArticleResponse.Merge(dst, src)
}
...
func (*DeleteArticleRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_article_032e5e91cdf93eb6, []int{8}
}
...
func (dst *DeleteArticleRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DeleteArticleRequest.Merge(dst, src)
}
...
func (*DeleteArticleResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_article_032e5e91cdf93eb6, []int{9}
}
...
func (dst *DeleteArticleResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DeleteArticleResponse.Merge(dst, src)
}
...
func (*ListArticleRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_article_032e5e91cdf93eb6, []int{10}
}
...
func (dst *ListArticleRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ListArticleRequest.Merge(dst, src)
}
...
func (*ListArticleResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_article_032e5e91cdf93eb6, []int{11}
}
...
func (dst *ListArticleResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ListArticleResponse.Merge(dst, src)
}
...
func (c *articleServiceClient) CreateArticle(ctx context.Context, in *CreateArticleRequest, opts ...grpc.CallOption) (*CreateArticleResponse, error) {
	...
	err := grpc.Invoke(ctx, "/article.ArticleService/CreateArticle", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *articleServiceClient) ReadArticle(ctx context.Context, in *ReadArticleRequest, opts ...grpc.CallOption) (*ReadArticleResponse, error) {
	...
	err := grpc.Invoke(ctx, "/article.ArticleService/ReadArticle", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *articleServiceClient) UpdateArticle(ctx context.Context, in *UpdateArticleRequest, opts ...grpc.CallOption) (*UpdateArticleResponse, error) {
	...
	err := grpc.Invoke(ctx, "/article.ArticleService/UpdateArticle", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *articleServiceClient) DeleteArticle(ctx context.Context, in *DeleteArticleRequest, opts ...grpc.CallOption) (*DeleteArticleResponse, error) {
	...
	err := grpc.Invoke(ctx, "/article.ArticleService/DeleteArticle", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *articleServiceClient) ListArticle(ctx context.Context, in *ListArticleRequest, opts ...grpc.CallOption) (ArticleService_ListArticleClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_ArticleService_serviceDesc.Streams[0], c.cc, "/article.ArticleService/ListArticle", opts...)
	if err != nil {
		return nil, err
	}
...
func init() { proto.RegisterFile("article/article.proto", fileDescriptor_article_032e5e91cdf93eb6) }

var fileDescriptor_article_032e5e91cdf93eb6 = []byte{
