...
func (tu *TestUpdate) SetTest(b bool) *TestUpdate {
	tu.mutation.SetTest(b)
	return tu
}

// SetNillableTest sets the "test" field if the given value is not nil.
func (tu *TestUpdate) SetNillableTest(b *bool) *TestUpdate {
	if b != nil {
		tu.SetTest(*b)
	}
	return tu
...
// SetTest sets the "test" field.
func (tuo *TestUpdateOne) SetTest(b bool) *TestUpdateOne {
	tuo.mutation.SetTest(b)
	return tuo
}

// SetNillableTest sets the "test" field if the given value is not nil.
func (tuo *TestUpdateOne) SetNillableTest(b *bool) *TestUpdateOne {
	if b != nil {
		tuo.SetTest(*b)
	}
	return tuo
